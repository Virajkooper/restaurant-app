		...
		<div class="menu-category">
				...
				<ul>
					...
					<li>004 Seafood Rice <span class="price">Rs.1700.00</span> <span
						class="description">A rich and flavorful dish with a mix of
							seafood and Chicken, cooked in spiced rice.</span>
					</li>
				</ul>
			</div>
			...
			<div class="menu-items">
				...
				<ul>
					...
					<li>007. Vegetable Spring Rolls <span class="price">Rs.950.00</span>
						<span class="description">Golden-fried spring rolls stuffed
							with fresh vegetables, served with sweet chili sauce.</span>
					</li>
					<li>008. Spicy Chicken Satay <span class="price">Rs.1350.00</span> <span class="description">Grilled chicken skewers
							marinated in spicy peanut sauce, served with cucumber relish.</span>
					</li>
				</ul>
